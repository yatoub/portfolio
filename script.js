...
const translations = {
    en: {
        ...
        lab: {
            ...
            wg:      { name: 'WGDashboard',    desc: 'WireGuard VPN management dashboard — peers, tunnels, traffic monitoring.' },
            grafana: { name: 'Grafana',        desc: 'Metrics and observability dashboards — infrastructure, services, alerts.' },
            arcane:  { name: 'Arcane',         desc: 'Docker management frontend — containers, images, volumes, logs.' },
            n8n:     { name: 'n8n',            desc: 'Workflow automation platform — integrations, triggers, pipelines.' },
            proxmox: { name: 'Proxmox',        desc: 'Hypervisor management interface — VMs, containers, storage. Requires WireGuard tunnel.' },
            open:      'OPEN',
            status:    'ONLINE',
            tunnelonly: 'VPN ONLY',
        },
    ...
    fr: {
        ...
        lab: {
            ...
            wg:      { name: 'WGDashboard',    desc: "Interface de gestion WireGuard — pairs, tunnels, supervision du trafic." },
            grafana: { name: 'Grafana',        desc: "Dashboards de métriques et d'observabilité — infrastructure, services, alertes." },
            arcane:  { name: 'Arcane',         desc: "Frontend de gestion Docker — conteneurs, images, volumes, logs." },
            n8n:     { name: 'n8n',            desc: "Plateforme d'automatisation de workflows — intégrations, déclencheurs, pipelines." },
            proxmox: { name: 'Proxmox',        desc: "Interface de gestion de l'hyperviseur — VMs, conteneurs, stockage. Nécessite le tunnel WireGuard." },
            open:      'OUVRIR',
            status:    'EN LIGNE',
            tunnelonly: 'VPN REQUIS',
        },
